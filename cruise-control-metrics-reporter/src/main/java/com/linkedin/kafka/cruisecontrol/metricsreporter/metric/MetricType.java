...
public enum MetricType {
  ...
  BROKER_LOG_FLUSH_RATE((byte) 34),
  BROKER_LOG_FLUSH_TIME_MS_MAX((byte) 35),
  BROKER_LOG_FLUSH_TIME_MS_MEAN((byte) 36),
  BROKER_PRODUCE_LOCAL_TIME_MS_MAX((byte) 37),
  BROKER_PRODUCE_LOCAL_TIME_MS_MEAN((byte) 38),
  BROKER_CONSUMER_FETCH_LOCAL_TIME_MS_MAX((byte) 39),
  BROKER_CONSUMER_FETCH_LOCAL_TIME_MS_MEAN((byte) 40),
  BROKER_FOLLOWER_FETCH_LOCAL_TIME_MS_MAX((byte) 41),
  BROKER_FOLLOWER_FETCH_LOCAL_TIME_MS_MEAN((byte) 42);
  private byte _id;
