...
public enum RawMetricType {
  ...
  BROKER_PRODUCE_REQUEST_QUEUE_TIME_MS_50TH(BROKER, (byte) 43),
  BROKER_PRODUCE_REQUEST_QUEUE_TIME_MS_999TH(BROKER, (byte) 44),
  BROKER_CONSUMER_FETCH_REQUEST_QUEUE_TIME_MS_50TH(BROKER, (byte) 45),
  BROKER_CONSUMER_FETCH_REQUEST_QUEUE_TIME_MS_999TH(BROKER, (byte) 46),
  BROKER_FOLLOWER_FETCH_REQUEST_QUEUE_TIME_MS_50TH(BROKER, (byte) 47),
  BROKER_FOLLOWER_FETCH_REQUEST_QUEUE_TIME_MS_999TH(BROKER, (byte) 48),
  BROKER_PRODUCE_TOTAL_TIME_MS_50TH(BROKER, (byte) 49),
  BROKER_PRODUCE_TOTAL_TIME_MS_999TH(BROKER, (byte) 50),
  BROKER_CONSUMER_FETCH_TOTAL_TIME_MS_50TH(BROKER, (byte) 51),
  BROKER_CONSUMER_FETCH_TOTAL_TIME_MS_999TH(BROKER, (byte) 52),
  BROKER_FOLLOWER_FETCH_TOTAL_TIME_MS_50TH(BROKER, (byte) 53),
  BROKER_FOLLOWER_FETCH_TOTAL_TIME_MS_999TH(BROKER, (byte) 54),
  BROKER_PRODUCE_LOCAL_TIME_MS_50TH(BROKER, (byte) 55),
  BROKER_PRODUCE_LOCAL_TIME_MS_999TH(BROKER, (byte) 56),
  BROKER_CONSUMER_FETCH_LOCAL_TIME_MS_50TH(BROKER, (byte) 57),
  BROKER_CONSUMER_FETCH_LOCAL_TIME_MS_999TH(BROKER, (byte) 58),
  BROKER_FOLLOWER_FETCH_LOCAL_TIME_MS_50TH(BROKER, (byte) 59),
  BROKER_FOLLOWER_FETCH_LOCAL_TIME_MS_999TH(BROKER, (byte) 60),
  BROKER_LOG_FLUSH_TIME_MS_50TH(BROKER, (byte) 61),
  BROKER_LOG_FLUSH_TIME_MS_999TH(BROKER, (byte) 62);
