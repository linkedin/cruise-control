...
public class ExecutionTaskPlannerTest {
  ...
  public void testGetLeaderMovementTasks() {
    ...
    manager.setExecutionConcurrency(0, MAX_BROKER_CONCURRENCY, ConcurrencyType.LEADERSHIP_BROKER);
    manager.setExecutionConcurrency(1, MAX_BROKER_CONCURRENCY, ConcurrencyType.LEADERSHIP_BROKER);
    manager.setExecutionConcurrency(2, MAX_BROKER_CONCURRENCY, ConcurrencyType.LEADERSHIP_BROKER);
    manager.setExecutionConcurrency(3, MAX_BROKER_CONCURRENCY, ConcurrencyType.LEADERSHIP_BROKER);
    ...
    manager.setExecutionConcurrencyForAllBrokers(3, ConcurrencyType.LEADERSHIP_CLUSTER);
    manager.setExecutionConcurrency(0, MAX_BROKER_CONCURRENCY, ConcurrencyType.LEADERSHIP_BROKER);
    manager.setExecutionConcurrency(1, MIN_BROKER_CONCURRENCY, ConcurrencyType.LEADERSHIP_BROKER);
    manager.setExecutionConcurrency(2, MAX_BROKER_CONCURRENCY, ConcurrencyType.LEADERSHIP_BROKER);
    manager.setExecutionConcurrency(3, MAX_BROKER_CONCURRENCY, ConcurrencyType.LEADERSHIP_BROKER);
    proposals = new ArrayList<>();
    proposals.add(_leaderMovement1);
