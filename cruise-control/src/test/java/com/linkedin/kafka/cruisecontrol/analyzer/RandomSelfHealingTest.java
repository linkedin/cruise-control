...
public class RandomSelfHealingTest {
  ...
  public static Collection<Object[]> data() throws AnalysisInputException {
    ...
    softGoalNameByPriority.put(3, TopicReplicaDistributionGoal.class.getName());
    softGoalNameByPriority.put(4, ResourceDistributionGoal.class.getName());
    softGoalNameByPriority.put(5, ReplicaDistributionGoal.class.getName());
