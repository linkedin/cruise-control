...
public class RandomClusterExpDistRebalanceTest extends RandomClusterTest {
   ...
   */
  public RandomClusterExpDistRebalanceTest(Map<ClusterProperty, Number> modifiedProperties,
