...
public class RandomClusterLinearDistRebalanceTest extends RandomClusterTest {
   ...
   */
  public RandomClusterLinearDistRebalanceTest(Map<ClusterProperty, Number> modifiedProperties,
