...
public class RandomClusterUniformDistRebalanceTest extends RandomClusterTest {
   ...
   */
  public RandomClusterUniformDistRebalanceTest(Map<ClusterProperty, Number> modifiedProperties,
