 ...
 * Each anomaly type has a priority, which determines order of anomalies being handled inside {@link com.linkedin.kafka.cruisecontrol.detector.AnomalyDetector}
 ...
 *  <li>{@link #SLOW_BROKER}: Broker performance degradations.</li>
