...
public class TopicReplicaDistributionGoal extends AbstractGoal {
  ...
  @Override
  public String name() {
    return TopicReplicaDistributionGoal.class.getName();
  }
  ...
  protected void rebalanceForBroker(Broker broker,
    ...
    _succeeded = _succeeded && _replicaDistributionTargetByTopic.get(_currentRebalanceTopic)
        .moveReplicasInSourceBrokerToEligibleBrokers(clusterModel, topicReplicasInBroker, optimizedGoals, excludedTopics);
  }
