...
public class MetricAnomalyDetector implements Runnable {
  ...
  public MetricAnomalyDetector(LoadMonitor loadMonitor, Queue<Anomaly> anomalies) {
    _loadMonitor = loadMonitor;
    _anomalies = anomalies;
    _kafkaMetricAnomalyAnalyzer = new KafkaMetricAnomalyAnalyzer();
  }
  ...
  public void run() {
    ...
    Collection<MetricAnomaly> anomalies = _kafkaMetricAnomalyAnalyzer.metricAnomalies(metricsHistoryByBroker, currentMetricsByBroker);
