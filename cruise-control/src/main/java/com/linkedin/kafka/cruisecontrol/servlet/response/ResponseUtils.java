...
public final class ResponseUtils {
   ...
   */
  public static void writeErrorResponse(CruiseControlRequestContext context,
                                        Exception e,
                                        String errorMessage,
                                        int responseCode,
                                        boolean json,
    ...
    context.writeResponseToOutputStream(responseCode, json, wantJsonSchema, responseMessage);
  }
