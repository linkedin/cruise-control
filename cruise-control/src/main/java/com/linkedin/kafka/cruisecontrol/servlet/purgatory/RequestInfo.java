...
public class RequestInfo {
  ...
  public <P extends CruiseControlParameters> RequestInfo(CruiseControlRequestContext context, P parameters) {
    if (context == null) {
    ...
    _submitterAddress = context.getClientIdentity();
    _submissionTimeMs = System.currentTimeMillis();
    _parameterMap = context.getParameterMap();
