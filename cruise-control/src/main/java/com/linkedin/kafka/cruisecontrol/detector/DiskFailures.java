...
public class DiskFailures extends KafkaAnomaly {
  protected static final String ID_PREFIX = AnomalyType.DISK_FAILURE.toString();
  ...
  public void configure(Map<String, ?> configs) {
    ...
    Map<Integer, Map<String, Long>> failedDisksByBroker = (Map<Integer, Map<String, Long>>) configs.get(FAILED_DISKS_CONFIG);
