...
public class ExecutionTaskManager {
   ...
   */
  public ExecutionTaskManager(MetricRegistry dropwizardMetricRegistry, Time time, KafkaCruiseControlConfig config) {
    ...
    _executionTaskPlanner = new ExecutionTaskPlanner(config);
