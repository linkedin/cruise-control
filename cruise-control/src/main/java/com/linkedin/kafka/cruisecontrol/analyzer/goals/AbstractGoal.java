 ...
 */
abstract class AbstractGoal implements Goal {
   ...
   */
  @Override
  public boolean optimize(Set<Goal> optimizedGoals, ClusterModel clusterModel, Set<String> excludedTopics)
   ...
   *
   * @return Human readable name of this goal.
   */
  @Override
   ...
   */
  protected abstract void healCluster(ClusterModel clusterModel, Set<Goal> optimizedGoals)
      throws AnalysisInputException, ModelInputException;
   ...
   */
  Integer maybeApplyBalancingAction(ClusterModel clusterModel,
                                    Replica replica,
    ...
    for (Broker broker : eligibleBrokers) {
      ...
      boolean canMove = selfSatisfied(clusterModel, optimizedGoalProposal)
